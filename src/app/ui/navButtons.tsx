  ...
  return (
    <div className="flex gap-4 mt-10">
      ...
      <div className="w-1/2 flex flex-col">
        ...
        <a href="/pages/data-structure/arrays.html" className="w-full bg-blue-custom text-white px-4 py-2 rounded hover:bg-blue-500 transition duration-300 ease-in-out text-center">
          Arrays
