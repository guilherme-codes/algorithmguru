  ...
  return (
    <>
      ...
      <ul className="list-disc list-inside list">
        <li><strong>Fixed Size:</strong> In many languages, arrays have a fixed size once created, though dynamic arrays can grow or shrink.</li>
        <li><strong>Zero-Indexed:</strong> Most programming languages start array indexing at 0, so the first element is at index 0.</li>
        <li><strong>Homogeneous:</strong> Arrays typically store elements of the same data type.</li>
        <li><strong>Contiguous Memory:</strong> Elements are stored in adjacent memory locations for efficient access.</li>
        <li><strong>Random Access:</strong> Any element can be accessed directly using its index in constant time O(1).</li>
      </ul>
      ...
      <ul className="list-disc list-inside list">
        <li><strong>Insertion:</strong> Adding an element at a specific index or at the end of the array.</li>
        <li><strong>Deletion:</strong> Removing an element from a specific index.</li>
        <li><strong>Traversal:</strong> Accessing each element of the array sequentially.</li>
        <li><strong>Search:</strong> Finding the index of a specific element.</li>
      ...
      <ul className="list-disc list-inside list">
        ...
        <li><strong>Insertion/Deletion at End:</strong> O(1) - Constant time</li>
        <li><strong>Insertion/Deletion at Middle:</strong> O(n) - Linear time, requires shifting elements</li>
        <li><strong>Search (Unsorted):</strong> O(n) - Linear search</li>
      ...
      <ul className="list-disc list-inside list">
        <li><strong>Storing Collections:</strong> Lists of numbers, strings, objects</li>
        <li><strong>Matrix and Table Representations:</strong> 2D and multidimensional data</li>
        <li><strong>Buffers:</strong> Temporary storage in graphics and audio processing</li>
        <li><strong>Caching:</strong> Quick access to recently used data</li>
